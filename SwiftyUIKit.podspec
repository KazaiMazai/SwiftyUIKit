...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/KazaiMazai/SwiftyUIKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Sergey Kazakov' => 'kazaimazai@gmail.com' }
  s.source           = { :git => 'https://github.com/KazaiMazai/SwiftyUIKit.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'SwiftyUIKit' => ['SwiftyUIKit/Assets/*.png']
  # }
